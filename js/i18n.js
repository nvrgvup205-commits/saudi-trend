(() => {
  const dict = {
    ar: {
      ...
      "services.sub": "اسحب أو لف — الكارت الأمامي ينقلب للتفاصيل · لوب سينمائي بلا نهاية",
    ...
    en: {
      ...
      "services.sub": "Drag or spin — flip the front card for details · endless cinema loop",
