(() => {
  const dict = {
    ar: {
      ...
      "hero.why": "لماذا نحن",
      "why.close": "إغلاق لماذا نحن",
      "why.tab": "فتح لماذا نحن",
      ...
      "portfolio.sub": "مواقع ومتاجر حقيقية لشركائنا — اضغط الموقع الأمامي للزيارة",
      "portfolio.ask": "إذا كان لديك أي أسئلة في ذهنك، فما عليك سوى النقر هنا",
      "portfolio.cta": "زيارة الموقع",
      "reels.kicker": "أعمالنا المرئية",
      "reels.title": "محتوى يتحرّك… ويبيع",
      "reels.sub": "ريلز وإعلانات وفيديوهات حقيقية أنتجناها لعلاماتنا — اضغط للتشغيل",
      "reels.hint": "اسحب أفقياً · اضغط للتشغيل · زر الصوت يشغّل أو يكتم",
      "reels.mute": "كتم الصوت",
      "reels.unmute": "تشغيل الصوت",
      "reel.aesthetic.title": "عيادات التجميل",
      "reel.aesthetic.tag": "ريلز طبي · محتوى بصري",
      "reel.sana.title": "مطعم سنا",
      "reel.sana.tag": "ريلز طعام · أكلات شامية",
      "reel.avatar.title": "أفاتار ذكي",
      "reel.avatar.tag": "فيديو AI · مقدم ثلاثي الأبعاد",
      "reel.etw.title": "اكتشف العالم",
      "reel.etw.tag": "إعلانات سياحة · وجهات فاخرة",
      "reel.mezanApp.title": "ميزان",
      "reel.mezanApp.tag": "عرض تطبيق · استشارات قانونية",
      "reel.mezanTalk.title": "ميزان — تعريفي",
      "reel.mezanTalk.tag": "فيديو مؤسسي · ثقة وأمان",
      ...
      "work.noc.title": "NOC — National Oasis",
      "work.noc.tag": "مقاولات · الإمارات",
      ...
      "footer.mapAria": "موقع سعودي ترند — حي اليرموك، الرياض",
      ...
      "footer.cr": "السجل التجاري: 1010659649",
    ...
    en: {
      ...
      "portfolio.sub": "Real partner sites & stores — click the front page to visit",
      "portfolio.ask": "Have a question in mind? Just click here",
      "portfolio.cta": "Visit site",
      "reels.kicker": "Visual work",
      "reels.title": "Content that moves… and sells",
      "reels.sub": "Real reels, ads, and videos we produced for our brands — tap to play",
      "reels.hint": "Swipe · tap to play · sound button mutes / unmutes",
      "reels.mute": "Mute",
      "reels.unmute": "Unmute",
      "reel.aesthetic.title": "Aesthetic clinics",
      "reel.aesthetic.tag": "Medical reels · visual content",
      "reel.sana.title": "Sana Restaurant",
      "reel.sana.tag": "Food reels · Levantine cuisine",
      "reel.avatar.title": "Smart avatar",
      "reel.avatar.tag": "AI video · 3D presenter",
      "reel.etw.title": "Discover the World",
      "reel.etw.tag": "Travel ads · luxury destinations",
      "reel.mezanApp.title": "Mezan",
      "reel.mezanApp.tag": "App showcase · legal consults",
      "reel.mezanTalk.title": "Mezan — intro",
      "reel.mezanTalk.tag": "Corporate video · trust & safety",
      ...
      "footer.mapAria": "Saudi Trend location — Al Yarmouk, Riyadh",
      "footer.site": "sauditrend.sa",
      ...
      "footer.cr": "Commercial Registration: 1010659649",
