(() => {
  const dict = {
    ar: {
      ...
      "hero.why": "لماذا نحن",
      "skill.1": "مختلفين في أفكارنا",
      "skill.2": "متمكّنين من شغلنا",
      "skill.3": "نقدر ننفّذ أي حاجة… حرفيًا",
      "skill.4": "عقودنا مرنة وقابلة للتفاوض لإرضاء العملاء",
      "skill.5": "نهتم بالقيمة",
      "skill.6": "نشتغل للناس كأنه شغلنا",
    ...
    en: {
      ...
      "hero.excel": "Why us",
      "hero.why": "Why us",
      "skill.1": "Different in our thinking",
      "skill.2": "Masters of our craft",
      "skill.3": "We can deliver anything — literally",
      "skill.4": "Flexible contracts, open to negotiation for our clients",
      "skill.5": "We care about value",
      "skill.6": "We work for people as if it were our own",
  ...
  window.ST_I18N = {
    ...
    apply,
    skills(lang) {
      return [1, 2, 3, 4, 5, 6].map((n) => t(lang, `skill.${n}`));
    },
  };
