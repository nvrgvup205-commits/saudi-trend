(() => {
  const dict = {
    ar: {
      ...
      "portfolio.sub": "لقطات فعلية من مواقع ومتاجر نفذناها لعملاء في السعودية — اضغط للزيارة",
    ...
    en: {
      ...
      "portfolio.sub": "Live screenshots of sites and stores we built for Saudi clients — click to visit",
